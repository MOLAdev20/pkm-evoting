        ...
        <div class="w-full max-w-md">
            ...
            <header class="mb-6 text-center">
                ...
                <p class="mt-1 text-xs text-slate-500">
                    Halaman ini sensitif dan hanya dapat diakses oleh orang yang berwenang
                </p>
            </header>

            <!-- Card login -->
            <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-soft sm:p-6">
                <?= form_open("login/administrator", ["class" => "space-y-4"]) ?>
                <!-- NIS / Email -->
            ...
            <div class="mt-5 text-center">
                <a href="/" class="inline-flex items-center gap-1 text-[11px] text-slate-500 hover:text-slate-700">
                    <span>Kembali ke halaman pemilihan</span>
                </a>
            </div>
        </div>
    </main>
